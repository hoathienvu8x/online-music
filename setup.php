...
<html lang="en">
<head>
<title>Music Library & Player Setup</title>
...
<div id="container" class="container-fluid">
	<div class="row playerrow setup-title-bar">
		<h1>Music Library & Player Setup</h1>
	</div>
	<?php
	$alert = null;
	...
	if ( $mode == 'success' )
	{
		...
		{
			rename ('config.php', 'config.backup.'.time().'.php');
			?>
			<div class="row">
		...
		{
			file_put_contents('config.php', $config_text);
			?>
			<div class="row">
				<div class="col-md-offset-2 col-md-8">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="well">
					...
					{
						?>
						<p>The form below will help set up your new <b>Music Library & Player</b> installation. You are most likely seeing this because a <b>config.php</b> file doesn't exist in this directory (<b><?php echo $_SERVER['SERVER_NAME'].str_replace($_SERVER['DOCUMENT_ROOT'], '', dirname($_SERVER['SCRIPT_FILENAME']));?>/</b>).</p>
						<?php
					}
					?>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="well">
						<div class="form-group">
							...
							<div class="radio">
								<label>
									<input name="debugging" type="radio" value="true" <?php echo $debugging_true;?>> Yes
								</label>
							</div>
							<div class="radio">
								<label>
							...
							<div class="radio">
								<label>
									<input name="group" type="radio" value="true" <?php echo $group_true;?>> Yes
								</label>
							</div>
							<div class="radio">
								<label>
							...
							<div class="radio">
								<label>
									<input name="download" type="radio" value="true" <?php echo $download_true;?>> Yes
								</label>
							</div>
							<div class="radio">
								<label>
							...
							<div class="radio">
								<label>
									<input name="m3u" type="radio" value="true" <?php echo $m3u_true;?>> Yes
								</label>
							</div>
							<div class="radio">
								<label>
							...
							<div class="radio">
								<label>
									<input type="radio" name="repeat" value="true" <?php echo $repeat_true;?>> Yes
								</label>
							</div>
							<div class="radio">
								<label>
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="well">
						<div class="form-group">
							...
							<div class="radio">
								<label>
									<input type="radio" name="skin" value="true" <?php echo $mlpskin_true;?>> Yes
								</label>
							</div>
							<div class="radio">
								<label>
